            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4">
                    <div class="facilities-image">
                        <img src="assets/img/facilities/facilities-1.png" alt="image">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="single-facilities">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-teacher-box">
                        <div class="image">
                            <img src="assets/img/teacher/teacher-5.png" alt="image">
                            <ul class="social">
                                <li>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-teacher-box">
                        <div class="image">
                            <img src="assets/img/teacher/teacher-6.png" alt="image">
                            <ul class="social">
                                <li>
                                    <a href="#" target="_blank">
                                        <i class='bx bxl-facebook'></i>
                ...
                <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
                    <div class="single-teacher-box">
                        <div class="image">
                            <img src="assets/img/teacher/teacher-7.png" alt="image">
                            <ul class="social">
                                <li>
                                    <a href="#" target="_blank">
                                        <i class='bx bxl-facebook'></i>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-8">
                            <div class="feedback-content">
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                    incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices
                                    gravida. Risus commodo viverra accumsan lacus vel facilisis. Lorem Ipsum is simply
                    ...
                    <div class="single-footer-widget">
                        ...
                        <ul class="footer-contact-info">
                            ...
                            <li>
                                ...
                                <span>Email</span>
                                <a
                                    href="https://templates.envytheme.com/cdn-cgi/l/email-protection#f199949d9d9eb19a9485909fdf929e9c"><span
                                        class="__cf_email__"
                                        data-cfemail="bad2dfd6d6d5fad1dfcedbd494d9d5d7">[email&#160;protected]</span></a>
                            </li>
                            <li>
                                <i class='bx bx-map'></i>
                                <span>Address</span>
